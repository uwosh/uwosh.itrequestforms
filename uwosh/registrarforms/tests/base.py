...
def setup_product():
    ...
    import uwosh.registrarforms
    zcml.load_config('configure.zcml', uwosh.registrarforms)
    ...
    ztc.installPackage('uwosh.registrarforms')
...
setup_product()
ptc.setupPloneSite(products=['uwosh.registrarforms'])
